...
def image_filter_and_crop(image, use_roi = False):
...
def lane_detection(image, line_optimized = True, show_intermediate_steps = True):
    height,width  = image.shape

    # Filter input image and edge detection
    canny_roi_image = image_filter_and_crop(image)
